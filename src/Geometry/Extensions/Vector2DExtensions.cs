...
/// <summary>
/// Extensions for <see cref="Vector2D"/> elements.
/// </summary>
public static class Vector2DExtensions
{
    ...
    public static double IncludedAngleWith(this Vector2D current, Vector2D other) =>
    ...
    /// False, otherwise.
    /// </returns>
    public static bool IsParallelTo(this Vector2D current, Vector2D other) => Relations.AreParallel(current, other);
    ...
    /// False, otherwise.
    /// </returns>
    public static bool IsPerpendicularTo(this Vector2D current, Vector2D other) =>
