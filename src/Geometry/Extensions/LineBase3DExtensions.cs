...
/// <summary>
/// Extensions for <see cref="LineBase3D"/> elements.
/// </summary>
public static class LineBase3DExtensions
{
    /// <summary>
    /// Solve included angle of current object and another one.
    /// </summary>
    /// <param name="current">Current <see cref="LineBase3D"/> object.</param>
    /// <param name="other">The other <see cref="LineBase3D"/> object.</param>
    /// <returns>The included angle of the objects.</returns>
    public static double IncludedAngleWith(this LineBase3D current, LineBase3D other) =>
    ...
    /// </returns>
    public static Point3D? IntersectionPointWith(this LineBase3D current, LineBase3D other) =>
    ...
    /// False, otherwise.
    /// </returns>
    public static bool IsParallelTo(this LineBase3D current, LineBase3D other) => Relations.AreParallel(current, other);
    ...
    /// False, otherwise.
    /// </returns>
    public static bool IsPerpendicularTo(this LineBase3D current, LineBase3D other) =>
